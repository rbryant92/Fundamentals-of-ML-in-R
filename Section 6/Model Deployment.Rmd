...
server <- function(input, output) {
  ...
  observeEvent(input$predict, {
    ...
    # PR-AUC curve
    predictions_prob <- predict(model_en_US, new_data_transformed, type = "prob")
    pr_auc_plot <- ggplot() +
      geom_line(aes(x = predictions_prob$.pred_1, y = cumsum(predictions_prob$.pred_1) / sum(predictions_prob$.pred_1)), color = "blue") +
